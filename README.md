...
This is set up to deploy on Vercel with zero config — just import the repo and Vercel will detect it as a Vite project automatically (build command `npm run build`, output directory `dist`).
